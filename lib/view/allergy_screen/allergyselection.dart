...
class _FoodAllergyState extends State<FoodAllergy> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text("Food Allergens",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.black),),
        elevation: 0,
        backgroundColor: Colors.white,
      ),
      body: Center(
        child: Column(
          ...
          children: [
            Padding(
             ...
             Text("Select ingredients you are allergic to",style: TextStyle(fontSize: 15)),
             Expanded(
               child: Container(
                height: 100,
                color: Colors.white,
                ...
                // circular avatar(allergy selection)
                 child: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3),
                  itemCount: allergy.length,itemBuilder: (context, index) =>
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child:Padding(
                                ...
                                child: Center(child: Text(allergy[index]["name"],style: TextStyle(fontSize: 13),)),
                              )),
                          )
                      ] ),
                  ),
              ...
              child: Container(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("Write your other allergies",style: TextStyle(fontSize: 18,fontWeight:FontWeight.bold ),),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>Dietselect())),
                      child: Container(
                                  decoration: BoxDecoration(
                  ...
                  TextButton(onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Dietselect()));
                  }, 
